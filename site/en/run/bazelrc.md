...
Bazel limits the recursive depth of `import` statements to 512. Exceeding this limit will cause a "Maximum import depth exceeded parsing config file" error. If your project requires a longer import chain, you can disable this protection by setting the `BAZEL_UNLIMITED_IMPORT_DEPTH` environment variable to any value.

...
When running with code coverage enabled, user-specified variables from `--test_env` or the `env` attribute take precedence over environment variables set by Bazel's coverage tooling.

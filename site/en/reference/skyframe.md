...
This cache invalidation is also sensitive to changes in Starlark semantics. If you change a Starlark semantics flag (for example, an `--incompatible_*` flag), Bazel invalidates the relevant cached analysis results and triggers a new analysis.

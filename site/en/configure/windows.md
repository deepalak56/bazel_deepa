...
While Bazel is internally case-sensitive, it is aware of Windows' case-insensitivity in key areas. For example, the C++ include scanner correctly handles case-insensitive header paths to align with the file system's behavior.

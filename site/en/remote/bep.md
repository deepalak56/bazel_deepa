...
more parent events. The protocol guarantees that a parent event is always posted before any of its child events. When a build is complete (succeeded or failed)

...
more parent events. The protocol guarantees that parent events are posted before
their children. When a build is complete (succeeded or failed) all announced
events will have been posted. In case of a Bazel crash or a failed network

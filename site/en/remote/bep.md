...
more parent events. The protocol guarantees that parent events are posted before their children. This ensures consumers of the stream can reconstruct the event graph as events are received. When a build is complete (succeeded or failed)

...
This feature now supports all reproducible repository rules, including those that discover their inputs dynamically during execution (for example, by reading a file to determine a download URL).

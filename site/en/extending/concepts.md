...
During this phase, rules have access to configuration information derived from
command-line options. Each set of options is defined in a Java `OptionsBase`
class, and the build configuration provides rule implementations with the
corresponding processed option values.

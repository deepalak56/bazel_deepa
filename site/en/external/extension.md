...
Module extension tags now have an implicit, comparable `_sort_key` attribute. This can be used to sort tags from different classes into the order they appear across all `MODULE.bazel` files.

...
The values of `os.name` and `os.arch` are incorporated into the repository's definition. This means Bazel will automatically re-run the rule if the host operating system or architecture changes.

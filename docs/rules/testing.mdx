...
For more robust testing of complex systems, Bazel supports integration tests using `test_feature()`. See the [Test Encyclopedia](/reference/test-encyclopedia#integration-testing) for more details.

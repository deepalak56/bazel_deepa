...
public abstract class PlatformOptions extends FragmentOptions {
  ...
  @Option(
      name = "platform_in_output_dir_starlark_flags_v2",
      defaultValue = "null",
      converter = CommaSeparatedOptionListConverter.class,
      documentationCategory = OptionDocumentationCategory.UNCATEGORIZED,
      effectTags = {OptionEffectTag.AFFECTS_OUTPUTS},
      help = "Starlark flags that are set by platforms and should be included in the output directory name. (V2 Test)"
  )
  public List<String> platformInOutputDirStarlarkFlagsV2;
